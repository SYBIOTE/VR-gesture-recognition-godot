...
func _ready():
	...
	if Mode == MODES.Gameplay:
		...
		var game_tracker = load("res://scenes/tracked_object/gameplay/Q_recog_tracked_obj_game.tscn")
		controller.call_deferred("add_child",game_tracker.instance())
		queue_free()
